  ...
  return (
    <div className="min-h-screen bg-white dark:bg-black text-gray-900 dark:text-white">
      ...
      <div className="pt-16 p-8 max-w-4xl mx-auto">
        ...
        {/* Project Sections */}
        <h2 className="font-heading text-2xl font-semibold mt-8">Introduction/Context</h2>
        ...
        <h2 className="font-heading text-2xl font-semibold mt-8">Visualizing Temperature Climate Variability</h2>
        <p className="text-md text-gray-700 dark:text-gray-300 mt-4">
        ...
        <h2 className="font-heading text-2xl font-semibold mt-8">Visualizing Sea Level Climate Variability</h2>
        <p className="text-md text-gray-700 dark:text-gray-300 mt-4">
        ...
        <h2 className="font-heading text-2xl font-semibold mt-8">Future Directions</h2>
        <p className="text-md text-gray-700 dark:text-gray-300 mt-4">
