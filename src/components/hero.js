  ...
  return (
    <section id="hero" className="flex flex-col items-center space-y-6 p-6 max-w-7xl mx-auto dark:bg-gray-900 overflow-hidden">
      <div className="flex flex-col md:flex-row items-center md:space-x-8">
        ...
        {/* Hero Text */}
        <div className="text-center md:text-left mt-6 md:mt-0 overflow-hidden">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white flex flex-wrap space-x-2 overflow-hidden">
